...
function unspoken_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Домашняя страница', 'unspoken' ),
		'id' => 'homepage-widget-area',
		'description' => __( 'Домашняя страница работает только с "Главная страница" & "Место объявления"', 'unspoken' ),
	...
	// Sidebar
	register_sidebar( array(
		'name' => __( 'Боковая панель', 'unspoken' ),
		'id' => 'sidebar-widget-area',
		'description' => __( 'Область виджетов в боковой панели', 'unspoken' ),
	...
	register_sidebar( array(
		'name' => __( 'Место объявлений в заголовке', 'unspoken' ),
		'id' => 'header-widget-area',
		'description' => __( 'Разместить Объявления, максимальная ширина 468px', 'unspoken' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<span class="no-title">',
		'after_title' => '</span>',
	...
	register_sidebar( array(
		'name' => __( 'Место объявления под меню', 'unspoken' ),
	...
	register_sidebar( array(
		'name' => __( 'Нижняя часть', 'unspoken' ),
		'id' => 'bottom-widget-area',
		'description' => __( 'Нижняя область виджета', 'unspoken' ),
		'before_widget' => '<div id="%1$s" class="%2$s widget">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
